...
project = "diffusion_ts"
copyright = f"{date.today().year}, Sven Maurice Morlock"
...
modindex_common_prefix = ["diffusion_ts."]
...
htmlhelp_basename = "diffusion_tsdoc"
